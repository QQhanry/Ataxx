...
const QMetaObject Joueur::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_Joueur.data,
      qt_meta_data_Joueur,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Joueur::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Joueur.stringdata0))
        return static_cast<void*>(const_cast< Joueur*>(this));
